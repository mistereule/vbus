...
#			{ "offset" => 2,"name" => "Kollektor_Vorlauf","bitSize" => 15,"factor" => 0.1,"unit" => "°C" },
	...
	"7331" => {"name" => "SLR", "cmd" => "0100", "fields" => [
			{ "offset" =>  0,"name" => "Temperature_01","bitSize" => 15,"factor" => 0.1,"unit" => "°C" },
			{ "offset" =>  2,"name" => "Temperature_02","bitSize" => 15,"factor" => 0.1,"unit" => "°C" },
			{ "offset" =>  4,"name" => "Temperature_03","bitSize" => 15,"factor" => 0.1,"unit" => "°C" },
			{ "offset" =>  6,"name" => "Temperature_04","bitSize" => 15,"factor" => 0.1,"unit" => "°C" },
			{ "offset" =>  8,"name" => "Temperature_05","bitSize" => 15,"factor" => 0.1,"unit" => "°C" },
			{ "offset" => 10,"name" => "Temperature_06","bitSize" => 15,"factor" => 0.1,"unit" => "°C" },
			{ "offset" => 12,"name" => "Temperature_07","bitSize" => 15,"factor" => 0.1,"unit" => "°C" },
			{ "offset" => 14,"name" => "Temperature_08","bitSize" => 15,"factor" => 0.1,"unit" => "°C" },
			{ "offset" => 16,"name" => "Temperature_09","bitSize" => 15,"factor" => 0.1,"unit" => "°C" },
			...
			{ "offset" => 44,"name" => "Pump_R01","bitSize" => 8,"factor" => 1,"unit" => "%" },
			{ "offset" => 45,"name" => "Pump_R02","bitSize" => 8,"factor" => 1,"unit" => "%" },
			{ "offset" => 46,"name" => "Pump_R03","bitSize" => 8,"factor" => 1,"unit" => "%" },
			{ "offset" => 47,"name" => "Pump_R04","bitSize" => 8,"factor" => 1,"unit" => "%" },
			{ "offset" => 48,"name" => "Pump_R05","bitSize" => 8,"factor" => 1,"unit" => "%" },
			{ "offset" => 49,"name" => "Pump_R06","bitSize" => 8,"factor" => 1,"unit" => "%" },
			{ "offset" => 50,"name" => "Pump_R07","bitSize" => 8,"factor" => 1,"unit" => "%" },
			{ "offset" => 51,"name" => "Pump_R08","bitSize" => 8,"factor" => 1,"unit" => "%" },
			{ "offset" => 52,"name" => "Pump_R09","bitSize" => 8,"factor" => 1,"unit" => "%" },
